...
public class DragPanel : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler {
    ...
    public void OnPointerDown (PointerEventData data) {
        ...
        transform.parent.SetParent(GetComponentInParent<Canvas>().transform, false);
    ...
    {
        TimelineTabManager.Instance.UpdateStickerToCurrentTab(GetComponentInParent<Sticker>());
    }
